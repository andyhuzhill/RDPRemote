//! Agent-side clipboard implementation
//!
//! This module provides clipboard reading and writing capabilities
//! for the RDP Agent. Uses Windows native APIs on Windows,
//! and xclip/xsel/wl-clipboard on Linux.
...
/// Clipboard reader for the agent
...
impl ClipboardReader {
    ...
    fn read_text_windows(&self) -> Result<Option<String>> {
        ...
        use windows::Win32::Foundation::{GlobalLock, GlobalUnlock, HGLOBAL};
...
/// Clipboard writer for the agent
...
impl ClipboardWriter {
    ...
    fn write_text_windows(&self, content: &str) -> Result<()> {
        ...
        use windows::Win32::Foundation::{
            GlobalAlloc, GlobalFree, GlobalLock, GlobalUnlock, GHND, HGLOBAL,
        };
        use std::ffi::OsStr;
